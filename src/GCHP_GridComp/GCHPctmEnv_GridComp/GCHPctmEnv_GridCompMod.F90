...
! !INTERFACE:
!
   subroutine calculate_ple(LM, PS, PLE, SPHU, topDownMet )
      use m_set_eta, only: set_eta
!
! !INPUT PARAMETERS:
!
...
!
      ...
      integer             :: num_levels, num_edges, ls, status
      real(r8), allocatable :: AP(:), BP(:)
      real(r8)            :: PEdge_Bot, PEdge_Top, PSDry, ptop, pint
      integer             :: I, J, L, is, ie, js, je
